...
from the original image. The same processing could also be be achieved by a single command \ijmenu{Process > Filter > Unsharp Mask\ldots]}.  The band-pass function under \ijmenu{[Process >
FFT]} could be used for the true high-pass filtering, but in my experience the result of pseudo-highpass filtering is more usable for segmentation purpose. 
...
Macros Recorder\ldots]}. A recorder window pops up:
